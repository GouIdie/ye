...
namespace Project
{
    ...
    {       
        public Signup Signup = new Signup(); // new object for the signup form is created using the Signup class

        public Login Login = new Login(); // new object for the login form is created using the Login class
        ...
        public Main()
        {
            ...
            Login.ButtonWasClicked += new Login.ClickButton(Login_ButtonWasClicked); //Allows a new method to be created to respond to the ButtonWasClicked event from the login form         
        }
       ...
       // void objForm1_SendID()
        ...
        private void Login_ButtonWasClicked()
        {
            ID = Login.getID; //Uses the getID method from login to find the users ID
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            Signup.FormBorderStyle = System.Windows.Forms.FormBorderStyle.None;
